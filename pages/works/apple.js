...
const Work = () => (
  <Layout title="Apple Transactiional">
    <Container>
      <Title>
      ...
      <WorkImage
        src="/images/works/apple-transactional-gif.gif"
        alt="email scrolling gif"
      />
      <WorkImage src="/images/works/apple-transactional-preview.png" alt="mobile view screenshot" />
    </Container>
  </Layout>
)
